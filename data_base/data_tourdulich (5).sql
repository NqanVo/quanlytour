...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 02, 2022 lúc 06:51 PM
...
CREATE TABLE `tbl_dangkytour_chitiet` (
  ...
  `thanhtien_dangkytour_chitiet` varchar(200) COLLATE utf8_unicode_520_ci NOT NULL,
...
CREATE TABLE `tbl_hotro_kinhphi` (
  ...
  `tongtien_hotro_kinhphi` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(2, 2019, 2022, '200000000', '0'),
(3, 2022, 2023, '200000000', '1');
...
(9, 3, 'Trần Văn C', '098694378', 'Tiền Giang', 'vanc@gmail.com', '0123456789', 'nam', '2022-06-18', '2', 'user1', 'e10adc3949ba59abbe56e057f20f883e', '1');
...
CREATE TABLE `tbl_nhan_hotro` (
  ...
  `id_nhanvien` int(200) NOT NULL,
  `id_tourdulich` int(200) NOT NULL,
  `sotien_nhan_hotro` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tbl_tourdulich` (
  ...
  `soluongdadangky_tourdulich` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `soluongtoida_tourdulich` varchar(200) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `tbl_dangkytour`
  MODIFY `id_dangkytour` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT cho bảng `tbl_dangkytour_chitiet`
--
ALTER TABLE `tbl_dangkytour_chitiet`
  MODIFY `id_dangkytour_chitiet` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `tbl_donvi`
  MODIFY `id_donvi` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `tbl_hotro_kinhphi`
--
ALTER TABLE `tbl_hotro_kinhphi`
  MODIFY `id_hotro_kinhphi` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `tbl_hotro_kinhphi_chitiet2`
--
ALTER TABLE `tbl_hotro_kinhphi_chitiet2`
  MODIFY `id_hotro_kinhphi_chitiet` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `tbl_nhanvien`
--
ALTER TABLE `tbl_nhanvien`
  MODIFY `id_nhanvien` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `tbl_nhan_hotro`
--
ALTER TABLE `tbl_nhan_hotro`
  MODIFY `id_nhan_hotro` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT cho bảng `tbl_phongban`
--
ALTER TABLE `tbl_phongban`
  MODIFY `id_phongban` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `tbl_tourdulich`
--
ALTER TABLE `tbl_tourdulich`
  MODIFY `id_tourdulich` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
