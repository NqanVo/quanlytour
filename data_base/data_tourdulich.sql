...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 12, 2022 lúc 03:16 AM
...
INSERT INTO `tbl_dangkytour` (`id_dangkytour`, `id_nhanvien`, `id_tourdulich`, `tentour_dangkytour`, `ngaydi_dangkytour`, `ngayve_dangkytour`, `ngaydangky_dangkytour`, `soluong_dangkytour`) VALUES
(34, 1, 20, 'Tp.HCM - Hội An - La Vang - Động Phong Nha - Huế 4 ngày 3 đêm Có Vé Máy Bay', '2022-07-23', '2022-07-26', '2022-07-06', '2'),
(35, 2, 20, 'Tp.HCM - Hội An - La Vang - Động Phong Nha - Huế 4 ngày 3 đêm Có Vé Máy Bay', '2022-07-23', '2022-07-26', '2022-07-06', '1'),
(36, 6, 13, 'Du Lịch Miền Tây: Đà Nẵng - Sóc Trăng - Bạc Liêu - Cà Mau - Đất Mũi - Cần Thơ 4 Ngày, Bay Vietjet Air + KS 3*', '2022-07-26', '2022-07-29', '2022-07-06', '1'),
(37, 2, 13, 'Du Lịch Miền Tây: Đà Nẵng - Sóc Trăng - Bạc Liêu - Cà Mau - Đất Mũi - Cần Thơ 4 Ngày, Bay Vietjet Air + KS 3*', '2022-07-26', '2022-07-29', '2022-07-08', '1'),
(38, 2, 10, 'Du Lịch Hạ Long Cao Cấp: Hà Nội - Hạ Long 3N2Đ - Du thuyền 5 sao & Khách sạn Hạ Long 5 sao', '2022-07-23', '2022-07-27', '2022-07-08', '2');
...
--
ALTER TABLE `tbl_dangkytour`
  MODIFY `id_dangkytour` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT cho bảng `tbl_dangkytour_chitiet`
--
ALTER TABLE `tbl_dangkytour_chitiet`
  MODIFY `id_dangkytour_chitiet` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `tbl_donvi`
  MODIFY `id_donvi` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tbl_nhanvien`
  MODIFY `id_nhanvien` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `tbl_nhan_hotro`
--
ALTER TABLE `tbl_nhan_hotro`
  MODIFY `id_nhan_hotro` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT cho bảng `tbl_phongban`
--
ALTER TABLE `tbl_phongban`
  MODIFY `id_phongban` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT cho bảng `tbl_tourdulich`
--
ALTER TABLE `tbl_tourdulich`
  MODIFY `id_tourdulich` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT cho bảng `tbl_tourdulich_liked`
--
ALTER TABLE `tbl_tourdulich_liked`
  MODIFY `id_tourdulich_liked` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
